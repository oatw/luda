...
import '../kernel/class/add-class.coffee'
import '../kernel/class/has-class.coffee'
import '../kernel/class/toggle-class.coffee'
import '../kernel/class/remove-class.coffee'
import '../kernel/data/data.coffee'
import '../kernel/data/remove-data.coffee'
import '../kernel/event/trigger.coffee'
import '../kernel/mixin/mixin.coffee'
import '../kernel/reflow/reflow.coffee'
import '../kernel/transition/transition.coffee'
...
luda.mixin 'tabable',
  ...
  tabableActivate: (index) ->
    return unless Type.isNumeric index
...
export default luda.mixin 'tabable'